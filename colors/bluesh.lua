...
local hlgroups = {
  ...
  StatusLine = { fg = c_foreground, bg = c_highlight },
  StatusLineNC = { fg = c_faded, bg = c_highlight },
  ...
  WarningMsg = { fg = c_orange },
  Whitespace = { link = "NonText" }, -- this is a color for list characters and whitespace
  ...
  MiniDiffSignChange = { fg = c_violet },
  ...
  -- statusline
  StatusLineDiagnosticError = { fg = c_critical, bg = c_highlight },
  StatusLineDiagnosticHint = { fg = c_foreground, bg = c_highlight },
  StatusLineDiagnosticInfo = { fg = c_salient, bg = c_highlight },
  StatusLineDiagnosticWarn = { fg = c_popout, bg = c_highlight },
  StatusLineGitAdded = { fg = c_pine, bg = c_highlight },
  StatusLineGitChanged = { fg = c_faded, bg = c_highlight },
