...
if vim.o.background == "dark" then
  palette = {
    ...
    base02 = "#0d2246", -- Selection Background
    ...
    base07 = "#a5bce9", -- Light Background (Not often used)
    ...
    base0F = "#de78d7", -- Deprecated, Opening/Closing Embedded Language Tags
  }
  use_cterm = {
    base00 = 235,
    base01 = 238,
