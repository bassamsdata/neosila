...
M.set_hl = function(group_name, opts)
  ...
  if opts.blend ~= nil then
    hl_opts.blend = M.clamp(opts.blend, 0, 100)
  end
...
local highlights = {
  ...
  ["TermCursor"] = { bg = M.shades.red[3] },
  ["TermCursorNC"] = { "TermCursor" },

  ["SpecialKey"] = { fg = c.special },
  ["Whitespace"] = { fg = c.comment },

  ["DiffAdd"] = { fg = c.fg, bg = M.shades.green[-3] },
  ["DiffChange"] = { fg = c.fg, bg = M.shades.blue[-3] },
  ["DiffDelete"] = { fg = c.fg, bg = M.shades.red[-3] },
  ["DiffText"] = { fg = c.fg, bg = c.mg },
  ...
  -- Map
  ["MiniMapNormal"] = {},
  ["MiniMapSymbolLine"] = { fg = c.fg, bg = c.bg },
  ...
  -- glance.nvim
  GlanceBorderTop = { fg = c.mod_alt },
  GlancePreviewBorderBottom = { fg = c.mod_alt },
  GlanceListBorderBottom = { fg = c.mod_alt },
  GlanceFoldIcon = { "Comment" },
  GlanceListCount = { fg = c.todo, bg = c.line },
  GlanceListCursorLine = { "CursorLine" },
  GlanceListNormal = { bg = c.bg },
  GlanceListMatch = { bg = c.info_dim, bold = true }, -- highlight the word
  GlancePreviewNormal = { bg = c.line },
  GlanceWinBarFilename = { fg = c.mod_alt, bg = c.bg, bold = true },
  GlanceWinBarFilepath = { fg = c.note, bg = c.bg },
  GlanceWinBarTitle = { fg = c.mod_alt, bg = c.bg, bold = true },
  GlanceListEndOfBuffer = { "CursorLine" },

  -- CursorLineNr highlights
  NormalMode = { "Cursor" },
  InsertMode = { fg = M.shades.green[-2], bold = true },
  VisualMode = { fg = M.shades.red[-2], bold = true },
  CommandMode = { fg = M.shades.yellow[-2], bold = true },

  -- Arrow:
  ArrowBookmarkSign = { fg = M.shades.blue[-3] },
  ArrowCurrentFile = { fg = M.shades.orange[-1] },
  ArrowCursor = { fg = M.shades.red[-1] },
  ...
  MiniDiffSignAdd = { fg = c.added },
  MiniDiffSignChange = { fg = c.changed },
  MiniDiffSignDelete = { fg = c.deleted },
